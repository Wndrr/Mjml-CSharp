    ...
    <mj-container background-color='#F2F2F2'>
      <mj-section vertical-align='center' padding-bottom='0px'>
        <mj-column vertical-align='middle'>
          ...
          <mj-image width='144' align='center' src='https://www.arturia.com/images/newsletters/2016-02-black/Logo-Baseline-0.15x.png' href='https://www.arturia.com' alt='></mj-image>
        </mj-column>
        <mj-column>
        </mj-column>
        <mj-column>
      ...
      <mj-section>
        <mj-column background-color='#FFFFFE'>
          ...
          <mj-text padding-top='25px' padding-bottom='25px' font-family='Helvetica,Arial,sans-serif' font-size='14px' line-height='120%'>Check out the iSpark introduction movie shot during the Arturia Experience event at the ADE featuring the Dutch beatmaker FilosofischeStilte.
          </mj-text>
        </mj-column>
      </mj-section>
      <mj-section>
        <mj-column background-color='#FFFFFE'>
          <mj-image padding-bottom='0px' padding-top='0px' padding-left='0px' padding-right='0px' src='https://www.arturia.com/images/newsletters/2016-02-ispark/07.jpg' href='https://www.arturia.com/products/ipad-synths/ispark/details' alt='>
          </mj-image>
      ...
      <mj-section>
        <mj-column background-color='#FFFFFE'>
          <mj-image padding-bottom='0px' padding-top='0px' padding-left='0px' padding-right='0px' src='https://www.arturia.com/images/newsletters/2016-02-ispark/08.jpg' href='https://www.arturia.com/products/ipad-synths/ispark/details' alt='>
          </mj-image>
          ...
          <mj-button background-color='#2DDCB4' padding-bottom='25px' border-radius='8px' href='https://www.arturia.com/products/ipad-synths/ispark/overview' font-size='14px' font-family='Helvetica,Arial,sans-serif' line-height='120%'>Learn more about iSpark</mj-button>
        </mj-column>
      </mj-section>
      <mj-section background-color='#000001'>
        <mj-column>
          <mj-text color='#FFFFFE' font-family='Helvetica,Arial,sans-serif' font-size='14px'>Musically yours,<br /> The Arturia Team
          </mj-text>
      ...
      <mj-section padding-left='0px' padding-right='0px' padding-top='0px' padding-bottom='0px'>
        <mj-column>
          <mj-image width='86' src='https://www.arturia.com/images/newsletters/2016-02-ispark/facebook_arturia.png' href='http://www.facebook.com/arturia2' alt='></mj-image>
        </mj-column>
        <mj-column>
          <mj-image width='86' src='https://www.arturia.com/images/newsletters/2016-02-ispark/youtube.png' href='http://www.youtube.com/arturiaweb' alt='></mj-image>
        </mj-column>
        <mj-column>
          <mj-image width='86' src='https://www.arturia.com/images/newsletters/2016-02-ispark/Soundcloud.png' href='http://soundcloud.com/arturia-official' alt='></mj-image>
        </mj-column>
        <mj-column>
          <mj-image width='86' src='https://www.arturia.com/images/newsletters/2016-02-ispark/twitter_arturia.png' href='http://twitter.com/arturiaofficial' alt='></mj-image>
        </mj-column>
      </mj-section>
      ...
      <mj-section padding-bottom='0px' padding-top='0px'>
        <mj-column>
          ...
          <mj-text padding-bottom='0px' font-family='Helvetica,Arial,sans-serif' font-size='10px' line-height='12px'>ARTURIA: <a href='https://www.arturia.com' style='text-decoration:none;color:#2DDCB4'>https://www.arturia.com</a> - Contact: <a href='mailto:info@arturia.com' style='text-decoration:none;color:#2DDCB4'>info</a><br /> ARTURIA France: 30 chemin
